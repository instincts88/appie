  ...
  <div class="section-layout">
    ...
    <div class="col-sm-10 booking-col">      
      ...
      <div class="confirmmation-box">
          <p class="confirmmation-note">Your appointment has been received. Pending confirmation. Thank you</p>
          <hr>
          <div class="booking-details">
              <h4>Appointment details</h4>
              <ul>
                  <li><span id="detailsTitle"><i class="fa fa-calendar" aria-hidden="true"></i> Date:</span> <span id="bookingDate"><?php echo $_SESSION['setdate']; ?> </span></li>
                  <li><span id="detailsTitle"><i class="fa fa-clock-o" aria-hidden="true"></i> Time Period:</span> <span id="bookingTime"><?php echo $_SESSION['settime']; ?></span></li>
              </ul>
          </div>
          <hr>
          <a href="index.php" class="btn proceed-btn">Done</a>
